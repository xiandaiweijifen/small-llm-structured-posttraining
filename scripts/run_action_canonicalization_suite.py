...
RUN_PRESETS = [
    ...
    "canonical_action_single_stage_epoch7_lr2e4",
    "canonical_action_single_stage_epoch9_lr2e4",
    "canonical_action_structure_then_semantics_v1",
    "canonical_action_structure_then_semantics_v1_lr1e4",
    "canonical_action_structure_then_semantics_stage2_epoch7",
    "canonical_action_structure_then_semantics_stage2_epoch9",
    "canonical_action_structure_then_semantics_stage2_epoch7_lr1e4",
]
SKIP_COMPLETED = True
...
PRESETS = {
    ...
    "canonical_action_single_stage_epoch7_lr2e4": {
        "experiment_name": "qwen25_3b_stage6_canonical_action_single_stage_epoch7_lr2e4",
        "mode": "full",
        "learning_rate": 2e-4,
        "epochs": 7,
        "batch_size": 8,
    ...
    "canonical_action_single_stage_epoch9_lr2e4": {
        "experiment_name": "qwen25_3b_stage6_canonical_action_single_stage_epoch9_lr2e4",
        "mode": "full",
        "learning_rate": 2e-4,
        "epochs": 9,
        "batch_size": 8,
    ...
    "canonical_action_structure_then_semantics_v1_lr1e4": {
        "experiment_name": "qwen25_3b_stage6_canonical_action_structure_then_semantics_v1_lr1e4",
        "mode": "two_stage_structure_semantics",
        "learning_rate": 1e-4,
        "stage1_epochs": 1,
        "stage2_epochs": 5,
    ...
    "canonical_action_structure_then_semantics_stage2_epoch7": {
        "experiment_name": "qwen25_3b_stage6_canonical_action_structure_then_semantics_stage2_epoch7",
        "mode": "two_stage_structure_semantics",
        "learning_rate": 2e-4,
        "stage1_epochs": 1,
        "stage2_epochs": 7,
    ...
    "canonical_action_structure_then_semantics_stage2_epoch9": {
        "experiment_name": "qwen25_3b_stage6_canonical_action_structure_then_semantics_stage2_epoch9",
        "mode": "two_stage_structure_semantics",
        "learning_rate": 2e-4,
        "stage1_epochs": 1,
        "stage2_epochs": 9,
    ...
    "canonical_action_structure_then_semantics_stage2_epoch7_lr1e4": {
        "experiment_name": "qwen25_3b_stage6_canonical_action_structure_then_semantics_stage2_epoch7_lr1e4",
        "mode": "two_stage_structure_semantics",
        "learning_rate": 1e-4,
        "stage1_epochs": 1,
        "stage2_epochs": 7,
